...
#define FOC_ANGLE_SYNC_RECOVERY_DIFF_RAD  (FOC_PI / 6.0f)
...
#define FOC_LATE_PERIOD_ANGLE_SYNC_FACTOR  FOC_ANGLE_SYNC_RECOVERY_FACTOR

#endif

#ifndef FOC_LATE_PERIOD_ANGLE_SYNC_STEP_MAX_RAD

#define FOC_LATE_PERIOD_ANGLE_SYNC_STEP_MAX_RAD  FOC_ANGLE_SYNC_RECOVERY_STEP_MAX_RAD
