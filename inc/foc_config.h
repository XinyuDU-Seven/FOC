...
#define FOC_ANGLE_SYNC_RECOVERY_DIFF_RAD  (FOC_PI / 2.0f)
...
#ifndef FOC_ANGLE_SYNC_SLEW_RATE_RAD_PER_S

#define FOC_ANGLE_SYNC_SLEW_RATE_RAD_PER_S  120.0f

#endif

#ifndef FOC_ANGLE_SYNC_PENDING_MAX_RAD

#define FOC_ANGLE_SYNC_PENDING_MAX_RAD  (FOC_PI / 3.0f)
