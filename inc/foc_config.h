...
#ifndef FOC_HALL_TRAVEL_STALL_MIN_COMMAND_COUNTS
#define FOC_HALL_TRAVEL_STALL_MIN_COMMAND_COUNTS  24U
#endif
...
#define FOC_HALL_NO_EDGE_DECAY_START_RATIO  1.05f
#endif

#ifndef FOC_HALL_NO_EDGE_DECAY_MIN_SPEED_RPM
#define FOC_HALL_NO_EDGE_DECAY_MIN_SPEED_RPM  100U
#endif
...
#ifndef FOC_HALL_NO_EDGE_ANGLE_CLAMP_EXTRA_FACTOR
#define FOC_HALL_NO_EDGE_ANGLE_CLAMP_EXTRA_FACTOR  0.25f
#endif

#ifndef FOC_HALL_NO_EDGE_ANGLE_CLAMP_STEP_MAX_RAD
#define FOC_HALL_NO_EDGE_ANGLE_CLAMP_STEP_MAX_RAD  (FOC_PI / 9.0f)
#endif
...
#ifndef FOC_REGEN_BRAKE_DISABLE_V
#define FOC_REGEN_BRAKE_DISABLE_V           14.6f
#endif
...
#define FOC_SPEED_ERROR_BOOST_DEADBAND_RPM  80.0f
#endif
...
#ifndef FOC_CCW_ACCEL_HOLD_ENABLE
#define FOC_CCW_ACCEL_HOLD_ENABLE       1U
#endif

#ifndef FOC_CCW_ACCEL_HOLD_MIN_REF_RPM
#define FOC_CCW_ACCEL_HOLD_MIN_REF_RPM  650U
#endif

#ifndef FOC_CCW_ACCEL_HOLD_ERR_RPM
#define FOC_CCW_ACCEL_HOLD_ERR_RPM      250U
#endif

#ifndef FOC_CCW_ACCEL_HOLD_RELEASE_PERCENT
#define FOC_CCW_ACCEL_HOLD_RELEASE_PERCENT  75U
#endif

#ifndef FOC_CCW_ACCEL_HOLD_IQ_MA
#define FOC_CCW_ACCEL_HOLD_IQ_MA        3300U
#endif

#ifndef FOC_PURE_SPEED_OPEN_LOOP_START_ENABLE
#define FOC_PURE_SPEED_OPEN_LOOP_START_ENABLE  1U
#endif

#ifndef FOC_PURE_SPEED_OPEN_LOOP_START_CCW_ONLY
#define FOC_PURE_SPEED_OPEN_LOOP_START_CCW_ONLY  1U
#endif

#ifndef FOC_PURE_SPEED_OPEN_LOOP_START_MIN_REF_RPM
#define FOC_PURE_SPEED_OPEN_LOOP_START_MIN_REF_RPM  20U
#endif

#ifndef FOC_PURE_SPEED_OPEN_LOOP_START_RPM
#define FOC_PURE_SPEED_OPEN_LOOP_START_RPM  220U
#endif

#ifndef FOC_PURE_SPEED_OPEN_LOOP_START_IQ_MA
#define FOC_PURE_SPEED_OPEN_LOOP_START_IQ_MA  3800U
#endif

#ifndef FOC_PURE_SPEED_OPEN_LOOP_START_RELEASE_RPM
#define FOC_PURE_SPEED_OPEN_LOOP_START_RELEASE_RPM  120U
#endif

#ifndef FOC_PURE_SPEED_OPEN_LOOP_START_EDGE_COUNT
#define FOC_PURE_SPEED_OPEN_LOOP_START_EDGE_COUNT  3U
#endif

#ifndef FOC_PURE_SPEED_OPEN_LOOP_START_MAX_MS
#define FOC_PURE_SPEED_OPEN_LOOP_START_MAX_MS  900U
#endif

#ifndef FOC_SPEED_CTRL_FDB_NO_EDGE_DECAY_RPM_PER_S
#define FOC_SPEED_CTRL_FDB_NO_EDGE_DECAY_RPM_PER_S  1500U
#endif
...
#ifndef FOC_LOW_SPEED_TORQUE_FULL_RPM
#define FOC_LOW_SPEED_TORQUE_FULL_RPM   250U
#endif
...
#ifndef FOC_LOW_SPEED_IQ_SLEW_ENABLE
#define FOC_LOW_SPEED_IQ_SLEW_ENABLE    1U
#endif

#ifndef FOC_LOW_SPEED_IQ_SLEW_MAX_RPM
#define FOC_LOW_SPEED_IQ_SLEW_MAX_RPM   650U
#endif

#ifndef FOC_LOW_SPEED_IQ_SLEW_UP_MA_PER_S
#define FOC_LOW_SPEED_IQ_SLEW_UP_MA_PER_S    6000U
#endif

#ifndef FOC_LOW_SPEED_IQ_SLEW_DOWN_MA_PER_S
#define FOC_LOW_SPEED_IQ_SLEW_DOWN_MA_PER_S  8000U
#endif

#ifndef FOC_BIDIR_DECEL_HOLD_ENABLE
#define FOC_BIDIR_DECEL_HOLD_ENABLE     1U
#endif

#ifndef FOC_BIDIR_DECEL_HOLD_MAX_RPM
#define FOC_BIDIR_DECEL_HOLD_MAX_RPM    650U
#endif

#ifndef FOC_BIDIR_DECEL_HOLD_MIN_IQ_MA
#define FOC_BIDIR_DECEL_HOLD_MIN_IQ_MA  700U
#endif

#ifndef FOC_BIDIR_DECEL_HOLD_FULL_RPM
#define FOC_BIDIR_DECEL_HOLD_FULL_RPM   350U
#endif

#ifndef FOC_BIDIR_DECEL_HOLD_ERR_RPM
#define FOC_BIDIR_DECEL_HOLD_ERR_RPM    80U
#endif
...
#define FOC_BIDIR_ZERO_SOFT_START_RPM   280U
#endif

#ifndef FOC_BIDIR_ZERO_TRANSFER_ENABLE
#define FOC_BIDIR_ZERO_TRANSFER_ENABLE  1U
#endif

#ifndef FOC_BIDIR_ZERO_TRANSFER_ENTER_RPM
#define FOC_BIDIR_ZERO_TRANSFER_ENTER_RPM  160U
#endif

#ifndef FOC_BIDIR_ZERO_TRANSFER_EXIT_RPM
#define FOC_BIDIR_ZERO_TRANSFER_EXIT_RPM   110U
#endif

#ifndef FOC_BIDIR_ZERO_TRANSFER_MS
#define FOC_BIDIR_ZERO_TRANSFER_MS      80U
#endif

#ifndef FOC_BIDIR_ZERO_RELAUNCH_MS
#define FOC_BIDIR_ZERO_RELAUNCH_MS      30U
#endif

#ifndef FOC_BIDIR_ZERO_RELAUNCH_EDGE_MAX_US
...
#ifndef FOC_BIDIR_ZERO_HANDOFF_CONFIRM_COUNT
#define FOC_BIDIR_ZERO_HANDOFF_CONFIRM_COUNT 3U
#endif
...
#ifndef FOC_BIDIR_ZERO_BREAKAWAY_IQ_MA
#define FOC_BIDIR_ZERO_BREAKAWAY_IQ_MA  1100
#endif

#ifndef FOC_BIDIR_ZERO_IQ_SLEW_MA_PER_S
...
#ifndef FOC_HALL_EDGE_SYNC_RECOVERY_STEP_MAX_RAD

#define FOC_HALL_EDGE_SYNC_RECOVERY_STEP_MAX_RAD  FOC_HALL_EDGE_SYNC_STEP_MAX_RAD
...
#ifndef FOC_LOW_SPEED_EDGE_SYNC_ENABLE

#define FOC_LOW_SPEED_EDGE_SYNC_ENABLE   1U

#endif

#ifndef FOC_LOW_SPEED_EDGE_SYNC_MAX_RPM

#define FOC_LOW_SPEED_EDGE_SYNC_MAX_RPM  FOC_LOW_SPEED_SMOOTH_MAX_RPM

#endif

#ifndef FOC_LOW_SPEED_EDGE_SYNC_STEP_MAX_RAD

#define FOC_LOW_SPEED_EDGE_SYNC_STEP_MAX_RAD  (FOC_PI / 72.0f)

#endif

#ifndef FOC_STARTUP_EDGE_SYNC_FACTOR

#define FOC_STARTUP_EDGE_SYNC_FACTOR    0.04f

#endif

#ifndef FOC_STARTUP_EDGE_SYNC_STEP_MAX_RAD

#define FOC_STARTUP_EDGE_SYNC_STEP_MAX_RAD  (FOC_PI / 60.0f)

#endif

#ifndef FOC_STARTUP_EDGE_SYNC_BOOST_COUNT
#define FOC_STARTUP_EDGE_SYNC_BOOST_COUNT  2U
#endif

#ifndef FOC_STARTUP_EDGE_SYNC_BOOST_FACTOR
#define FOC_STARTUP_EDGE_SYNC_BOOST_FACTOR 0.20f
#endif

#ifndef FOC_STARTUP_EDGE_SYNC_BOOST_STEP_MAX_RAD
#define FOC_STARTUP_EDGE_SYNC_BOOST_STEP_MAX_RAD  (FOC_PI / 18.0f)
#endif

#ifndef FOC_STARTUP_EDGE_SYNC_ADVANCE_MAX_RAD
#define FOC_STARTUP_EDGE_SYNC_ADVANCE_MAX_RAD  (FOC_PI / 36.0f)
#endif

#ifndef FOC_STARTUP_PRE_EDGE_CLAMP_ENABLE
#define FOC_STARTUP_PRE_EDGE_CLAMP_ENABLE  1U
#endif

#ifndef FOC_STARTUP_PRE_EDGE_MARGIN_RAD
#define FOC_STARTUP_PRE_EDGE_MARGIN_RAD    (FOC_PI / 18.0f)
#endif

#ifndef FOC_STARTUP_PRE_EDGE_PULL_MARGIN_RAD
#define FOC_STARTUP_PRE_EDGE_PULL_MARGIN_RAD  (FOC_PI / 3.0f)
#endif

#ifndef FOC_STARTUP_PRE_EDGE_CLAMP_STEP_MAX_RAD
#define FOC_STARTUP_PRE_EDGE_CLAMP_STEP_MAX_RAD  (FOC_PI / 18.0f)
#endif
...
#define FOC_ANGLE_SYNC_RECOVERY_FACTOR   0.5f

#endif

#ifndef FOC_ANGLE_SYNC_RECOVERY_STEP_MAX_RAD

#define FOC_ANGLE_SYNC_RECOVERY_STEP_MAX_RAD  (FOC_PI / 6.0f)
...
#define FOC_CCW_CONTROL_ANGLE_OFFSET_MRAD  (-300)
...
#ifndef FOC_LIFT_START_ANGLE_SEARCH_ENABLE

#define FOC_LIFT_START_ANGLE_SEARCH_ENABLE     1U

#endif

#ifndef FOC_LIFT_START_ANGLE_SEARCH_DELAY_MS

#define FOC_LIFT_START_ANGLE_SEARCH_DELAY_MS   20U

#endif

#ifndef FOC_LIFT_START_ANGLE_SEARCH_PERIOD_MS

#define FOC_LIFT_START_ANGLE_SEARCH_PERIOD_MS  120U

#endif

#ifndef FOC_LIFT_START_ANGLE_SEARCH_AMP_MRAD

#define FOC_LIFT_START_ANGLE_SEARCH_AMP_MRAD   450

#endif

#ifndef FOC_LIFT_START_ANGLE_SEARCH_MAX_RPM

#define FOC_LIFT_START_ANGLE_SEARCH_MAX_RPM    20U
...
#ifndef FOC_STARTUP_PREDICT_RELEASE_RPM

#define FOC_STARTUP_PREDICT_RELEASE_RPM 400.0f

#endif

#ifndef FOC_STARTUP_PREDICT_RELEASE_ERR_RPM

#define FOC_STARTUP_PREDICT_RELEASE_ERR_RPM 120.0f

#endif

#ifndef FOC_STARTUP_PREDICT_MEASURED_LEAD_RPM

#define FOC_STARTUP_PREDICT_MEASURED_LEAD_RPM 120.0f

#endif

#ifndef FOC_STARTUP_PREDICT_RELEASE_BLEND_RPM_PER_S

#define FOC_STARTUP_PREDICT_RELEASE_BLEND_RPM_PER_S 3000.0f

#endif

#ifndef FOC_STARTUP_PREDICT_RELEASE_BLEND_DONE_RPM

#define FOC_STARTUP_PREDICT_RELEASE_BLEND_DONE_RPM 5.0f
...
#define FOC_STARTUP_SPEED_LOCK_IQ_MAX_MA  5000U
...
#define FOC_HALL_ANGLE_TRIM_S1_RAD      (-(5.0f  / 180.0f) * FOC_PI)
#endif
...
#define FOC_HALL_ANGLE_TRIM_S3_RAD      (-(4.0f  / 180.0f) * FOC_PI)
#endif

#ifndef FOC_HALL_ANGLE_TRIM_S4_RAD
#define FOC_HALL_ANGLE_TRIM_S4_RAD      0.0f
#endif

#ifndef FOC_HALL_ANGLE_TRIM_S5_RAD
#define FOC_HALL_ANGLE_TRIM_S5_RAD      0.0f
#endif
...
/* Hall sector direction produced by a positive/CW speed command.
 * 0U: sector number increases, 1U: sector number decreases.
 */
...
#ifndef FOC_LOW_SPEED_SMOOTH_ENABLE

#define FOC_LOW_SPEED_SMOOTH_ENABLE     1U

#endif

#ifndef FOC_LOW_SPEED_SMOOTH_MAX_RPM

#define FOC_LOW_SPEED_SMOOTH_MAX_RPM    800.0f

#endif

#ifndef FOC_LOW_SPEED_CTRL_FILTER_ALPHA

#define FOC_LOW_SPEED_CTRL_FILTER_ALPHA 0.035f

#endif

#ifndef FOC_LOW_SPEED_OVERSPEED_DEADBAND_RPM

#define FOC_LOW_SPEED_OVERSPEED_DEADBAND_RPM  25.0f
